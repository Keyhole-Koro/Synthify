...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/synthify/backend/internal/gen/synthify/worker/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	WorkerServiceName = "synthify.worker.v1.WorkerService"
)
...
const (
	...
	WorkerServiceGenerateExecutionPlanProcedure = "/synthify.worker.v1.WorkerService/GenerateExecutionPlan"
	// WorkerServiceExecuteApprovedPlanProcedure is the fully-qualified name of the WorkerService's
	// ExecuteApprovedPlan RPC.
	WorkerServiceExecuteApprovedPlanProcedure = "/synthify.worker.v1.WorkerService/ExecuteApprovedPlan"
...
func NewWorkerServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) WorkerServiceClient {
	...
	workerServiceMethods := v1.File_synthify_worker_v1_worker_proto.Services().ByName("WorkerService").Methods()
...
// ExecuteApprovedPlan calls synthify.worker.v1.WorkerService.ExecuteApprovedPlan.
...
// EvaluateJobArtifact calls synthify.worker.v1.WorkerService.EvaluateJobArtifact.
...
func (UnimplementedWorkerServiceHandler) GenerateExecutionPlan(context.Context, *connect.Request[v1.GenerateExecutionPlanRequest]) (*connect.Response[v1.GenerateExecutionPlanResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.worker.v1.WorkerService.GenerateExecutionPlan is not implemented"))
}
...
func (UnimplementedWorkerServiceHandler) ExecuteApprovedPlan(context.Context, *connect.Request[v1.ExecuteApprovedPlanRequest]) (*connect.Response[v1.ExecuteApprovedPlanResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.worker.v1.WorkerService.ExecuteApprovedPlan is not implemented"))
}
