...
const (
	...
	WorkspaceServiceName = "synthify.app.v1.WorkspaceService"
)
...
const (
	...
	// CreateWorkspace RPC.
	WorkspaceServiceCreateWorkspaceProcedure = "/synthify.app.v1.WorkspaceService/CreateWorkspace"
	// WorkspaceServiceGetWorkspaceProcedure is the fully-qualified name of the WorkspaceService's
	// GetWorkspace RPC.
	WorkspaceServiceGetWorkspaceProcedure = "/synthify.app.v1.WorkspaceService/GetWorkspace"
	...
	WorkspaceServiceUpdateMemberRoleProcedure = "/synthify.app.v1.WorkspaceService/UpdateMemberRole"
	// WorkspaceServiceRemoveMemberProcedure is the fully-qualified name of the WorkspaceService's
	// RemoveMember RPC.
	WorkspaceServiceRemoveMemberProcedure = "/synthify.app.v1.WorkspaceService/RemoveMember"
	// WorkspaceServiceTransferOwnershipProcedure is the fully-qualified name of the WorkspaceService's
	// TransferOwnership RPC.
	WorkspaceServiceTransferOwnershipProcedure = "/synthify.app.v1.WorkspaceService/TransferOwnership"
...
func NewWorkspaceServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) WorkspaceServiceClient {
	...
	workspaceServiceMethods := v1.File_synthify_app_v1_workspace_proto.Services().ByName("WorkspaceService").Methods()
...
// GetWorkspace calls synthify.app.v1.WorkspaceService.GetWorkspace.
...
// UpdateMemberRole calls synthify.app.v1.WorkspaceService.UpdateMemberRole.
...
// RemoveMember calls synthify.app.v1.WorkspaceService.RemoveMember.
...
// TransferOwnership calls synthify.app.v1.WorkspaceService.TransferOwnership.
...
// DeleteWorkspace calls synthify.app.v1.WorkspaceService.DeleteWorkspace.
...
func (UnimplementedWorkspaceServiceHandler) CreateWorkspace(context.Context, *connect.Request[v1.CreateWorkspaceRequest]) (*connect.Response[v1.CreateWorkspaceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.app.v1.WorkspaceService.CreateWorkspace is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) GetWorkspace(context.Context, *connect.Request[v1.GetWorkspaceRequest]) (*connect.Response[v1.GetWorkspaceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.app.v1.WorkspaceService.GetWorkspace is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) InviteMember(context.Context, *connect.Request[v1.InviteMemberRequest]) (*connect.Response[v1.InviteMemberResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.app.v1.WorkspaceService.InviteMember is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) UpdateMemberRole(context.Context, *connect.Request[v1.UpdateMemberRoleRequest]) (*connect.Response[v1.UpdateMemberRoleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.app.v1.WorkspaceService.UpdateMemberRole is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) RemoveMember(context.Context, *connect.Request[v1.RemoveMemberRequest]) (*connect.Response[v1.RemoveMemberResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.app.v1.WorkspaceService.RemoveMember is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) TransferOwnership(context.Context, *connect.Request[v1.TransferOwnershipRequest]) (*connect.Response[v1.TransferOwnershipResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.app.v1.WorkspaceService.TransferOwnership is not implemented"))
}
