...
const (
	...
	BillingServiceName = "synthify.app.v1.BillingService"
)
...
const (
	...
	BillingServiceGetBillingAccountProcedure = "/synthify.app.v1.BillingService/GetBillingAccount"
	...
	BillingServiceCreateCheckoutSessionProcedure = "/synthify.app.v1.BillingService/CreateCheckoutSession"
	// BillingServiceCreatePortalSessionProcedure is the fully-qualified name of the BillingService's
	// CreatePortalSession RPC.
	BillingServiceCreatePortalSessionProcedure = "/synthify.app.v1.BillingService/CreatePortalSession"
	// BillingServiceGetUsageProcedure is the fully-qualified name of the BillingService's GetUsage RPC.
	BillingServiceGetUsageProcedure = "/synthify.app.v1.BillingService/GetUsage"
	// BillingServiceRecordUsageProcedure is the fully-qualified name of the BillingService's
	// RecordUsage RPC.
	BillingServiceRecordUsageProcedure = "/synthify.app.v1.BillingService/RecordUsage"
	// BillingServiceUpdateBudgetProcedure is the fully-qualified name of the BillingService's
	// UpdateBudget RPC.
	BillingServiceUpdateBudgetProcedure = "/synthify.app.v1.BillingService/UpdateBudget"
	// BillingServiceListInvoicesProcedure is the fully-qualified name of the BillingService's
	// ListInvoices RPC.
	BillingServiceListInvoicesProcedure = "/synthify.app.v1.BillingService/ListInvoices"
	// BillingServiceListPaymentMethodsProcedure is the fully-qualified name of the BillingService's
	// ListPaymentMethods RPC.
	BillingServiceListPaymentMethodsProcedure = "/synthify.app.v1.BillingService/ListPaymentMethods"
	// BillingServiceGrantCreditProcedure is the fully-qualified name of the BillingService's
	// GrantCredit RPC.
	BillingServiceGrantCreditProcedure = "/synthify.app.v1.BillingService/GrantCredit"
	// BillingServiceGetCreditBalanceProcedure is the fully-qualified name of the BillingService's
	// GetCreditBalance RPC.
	BillingServiceGetCreditBalanceProcedure = "/synthify.app.v1.BillingService/GetCreditBalance"
)

// BillingServiceClient is a client for the synthify.app.v1.BillingService service.
...
// NewBillingServiceClient constructs a client for the synthify.app.v1.BillingService service. By
...
func NewBillingServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) BillingServiceClient {
	...
	billingServiceMethods := v1.File_synthify_app_v1_billing_proto.Services().ByName("BillingService").Methods()
...
// GetBillingAccount calls synthify.app.v1.BillingService.GetBillingAccount.
...
// CreateCheckoutSession calls synthify.app.v1.BillingService.CreateCheckoutSession.
...
// CreatePortalSession calls synthify.app.v1.BillingService.CreatePortalSession.
...
// GetUsage calls synthify.app.v1.BillingService.GetUsage.
...
// RecordUsage calls synthify.app.v1.BillingService.RecordUsage.
...
// UpdateBudget calls synthify.app.v1.BillingService.UpdateBudget.
...
// ListInvoices calls synthify.app.v1.BillingService.ListInvoices.
...
// ListPaymentMethods calls synthify.app.v1.BillingService.ListPaymentMethods.
...
// GrantCredit calls synthify.app.v1.BillingService.GrantCredit.
...
// GetCreditBalance calls synthify.app.v1.BillingService.GetCreditBalance.
...
// BillingServiceHandler is an implementation of the synthify.app.v1.BillingService service.
...
func NewBillingServiceHandler(svc BillingServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/synthify.app.v1.BillingService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedBillingServiceHandler) GetBillingAccount(context.Context, *connect.Request[v1.GetBillingAccountRequest]) (*connect.Response[v1.GetBillingAccountResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.app.v1.BillingService.GetBillingAccount is not implemented"))
}
...
func (UnimplementedBillingServiceHandler) CreateCheckoutSession(context.Context, *connect.Request[v1.CreateCheckoutSessionRequest]) (*connect.Response[v1.CreateCheckoutSessionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.app.v1.BillingService.CreateCheckoutSession is not implemented"))
}
...
func (UnimplementedBillingServiceHandler) CreatePortalSession(context.Context, *connect.Request[v1.CreatePortalSessionRequest]) (*connect.Response[v1.CreatePortalSessionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.app.v1.BillingService.CreatePortalSession is not implemented"))
}
...
func (UnimplementedBillingServiceHandler) GetUsage(context.Context, *connect.Request[v1.GetUsageRequest]) (*connect.Response[v1.GetUsageResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.app.v1.BillingService.GetUsage is not implemented"))
}
...
func (UnimplementedBillingServiceHandler) RecordUsage(context.Context, *connect.Request[v1.RecordUsageRequest]) (*connect.Response[v1.RecordUsageResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.app.v1.BillingService.RecordUsage is not implemented"))
}
...
func (UnimplementedBillingServiceHandler) UpdateBudget(context.Context, *connect.Request[v1.UpdateBudgetRequest]) (*connect.Response[v1.UpdateBudgetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.app.v1.BillingService.UpdateBudget is not implemented"))
}
...
func (UnimplementedBillingServiceHandler) ListInvoices(context.Context, *connect.Request[v1.ListInvoicesRequest]) (*connect.Response[v1.ListInvoicesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.app.v1.BillingService.ListInvoices is not implemented"))
}
...
func (UnimplementedBillingServiceHandler) ListPaymentMethods(context.Context, *connect.Request[v1.ListPaymentMethodsRequest]) (*connect.Response[v1.ListPaymentMethodsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.app.v1.BillingService.ListPaymentMethods is not implemented"))
}
...
func (UnimplementedBillingServiceHandler) GrantCredit(context.Context, *connect.Request[v1.GrantCreditRequest]) (*connect.Response[v1.GrantCreditResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.app.v1.BillingService.GrantCredit is not implemented"))
}
...
func (UnimplementedBillingServiceHandler) GetCreditBalance(context.Context, *connect.Request[v1.GetCreditBalanceRequest]) (*connect.Response[v1.GetCreditBalanceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.app.v1.BillingService.GetCreditBalance is not implemented"))
}
