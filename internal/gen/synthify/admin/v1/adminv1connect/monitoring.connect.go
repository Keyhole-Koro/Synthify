...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/synthify/backend/internal/gen/synthify/admin/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	MonitoringServiceName = "synthify.admin.v1.MonitoringService"
)
...
const (
	...
	MonitoringServiceGetPipelineStatsProcedure = "/synthify.admin.v1.MonitoringService/GetPipelineStats"
	...
	MonitoringServiceGetExtractionStatsProcedure = "/synthify.admin.v1.MonitoringService/GetExtractionStats"
	...
	MonitoringServiceGetEvaluationTrendProcedure = "/synthify.admin.v1.MonitoringService/GetEvaluationTrend"
	...
	MonitoringServiceListFailedDocumentsProcedure = "/synthify.admin.v1.MonitoringService/ListFailedDocuments"
	...
	MonitoringServiceGetNormalizationStatsProcedure = "/synthify.admin.v1.MonitoringService/GetNormalizationStats"
	// MonitoringServiceGetAliasStatsProcedure is the fully-qualified name of the MonitoringService's
	// GetAliasStats RPC.
	MonitoringServiceGetAliasStatsProcedure = "/synthify.admin.v1.MonitoringService/GetAliasStats"
)

// MonitoringServiceClient is a client for the synthify.admin.v1.MonitoringService service.
...
// NewMonitoringServiceClient constructs a client for the synthify.admin.v1.MonitoringService
...
func NewMonitoringServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) MonitoringServiceClient {
	...
	monitoringServiceMethods := v1.File_synthify_admin_v1_monitoring_proto.Services().ByName("MonitoringService").Methods()
...
// GetPipelineStats calls synthify.admin.v1.MonitoringService.GetPipelineStats.
...
// GetExtractionStats calls synthify.admin.v1.MonitoringService.GetExtractionStats.
...
// GetEvaluationTrend calls synthify.admin.v1.MonitoringService.GetEvaluationTrend.
...
// ListFailedDocuments calls synthify.admin.v1.MonitoringService.ListFailedDocuments.
...
// GetNormalizationStats calls synthify.admin.v1.MonitoringService.GetNormalizationStats.
...
// GetAliasStats calls synthify.admin.v1.MonitoringService.GetAliasStats.
...
// MonitoringServiceHandler is an implementation of the synthify.admin.v1.MonitoringService service.
...
func NewMonitoringServiceHandler(svc MonitoringServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/synthify.admin.v1.MonitoringService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedMonitoringServiceHandler) GetPipelineStats(context.Context, *connect.Request[v1.GetPipelineStatsRequest]) (*connect.Response[v1.GetPipelineStatsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.admin.v1.MonitoringService.GetPipelineStats is not implemented"))
}
...
func (UnimplementedMonitoringServiceHandler) GetExtractionStats(context.Context, *connect.Request[v1.GetExtractionStatsRequest]) (*connect.Response[v1.GetExtractionStatsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.admin.v1.MonitoringService.GetExtractionStats is not implemented"))
}
...
func (UnimplementedMonitoringServiceHandler) GetEvaluationTrend(context.Context, *connect.Request[v1.GetEvaluationTrendRequest]) (*connect.Response[v1.GetEvaluationTrendResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.admin.v1.MonitoringService.GetEvaluationTrend is not implemented"))
}
...
func (UnimplementedMonitoringServiceHandler) ListFailedDocuments(context.Context, *connect.Request[v1.ListFailedDocumentsRequest]) (*connect.Response[v1.ListFailedDocumentsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.admin.v1.MonitoringService.ListFailedDocuments is not implemented"))
}
...
func (UnimplementedMonitoringServiceHandler) GetNormalizationStats(context.Context, *connect.Request[v1.GetNormalizationStatsRequest]) (*connect.Response[v1.GetNormalizationStatsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.admin.v1.MonitoringService.GetNormalizationStats is not implemented"))
}
...
func (UnimplementedMonitoringServiceHandler) GetAliasStats(context.Context, *connect.Request[v1.GetAliasStatsRequest]) (*connect.Response[v1.GetAliasStatsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.admin.v1.MonitoringService.GetAliasStats is not implemented"))
}
