...
func (s *Store) seed() {
	...
	ws := &domain.Workspace{
		...
		OwnerID:           "user_demo",
		Plan:              "pro",
		StorageUsedBytes:  2 << 20,
		StorageQuotaBytes: 50 << 30,
		MaxFileSizeBytes:  500 << 20,
		MaxUploadsPerDay:  200,
		CreatedAt:         n,
	}
	s.workspaces[ws.WorkspaceID] = ws
	s.members[ws.WorkspaceID] = []*domain.WorkspaceMember{
		{UserID: "user_demo", Email: "demo@synthify.dev", Role: "owner", IsDev: true, InvitedAt: n},
		{UserID: "user_alice", Email: "alice@synthify.dev", Role: "editor", IsDev: false, InvitedAt: n, InvitedBy: "user_demo"},
		{UserID: "user_bob", Email: "bob@synthify.dev", Role: "viewer", IsDev: false, InvitedAt: n, InvitedBy: "user_demo"},
	}
	...
	docs := []*domain.Document{
		{
			...
			WorkspaceID:     "ws_demo",
			UploadedBy:      "user_demo",
			Filename:        "sales_strategy.pdf",
			MimeType:        "application/pdf",
			FileSize:        512 << 10,
			Status:          domain.DocumentLifecycleCompleted,
		...
		},
		{
			...
			FileSize:     128 << 10,
			Status:       domain.DocumentLifecycleProcessing,
		...
		},
		{
			...
			MimeType:     "text/csv",
			FileSize:     64 << 10,
			Status:       domain.DocumentLifecycleFailed,
			ErrorMessage: "Gemini API timeout after 3 retries (pass1_extraction)",
			CreatedAt:    n,
			UpdatedAt:    n,
		},
	}
	...
	s.nodes["doc_sales"] = cloneSalesNodes("doc_sales")
	s.edges["doc_sales"] = cloneSalesEdges("doc_sales")
}
