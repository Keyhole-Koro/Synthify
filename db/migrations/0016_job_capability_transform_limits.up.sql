...
ALTER TABLE job_capabilities ADD COLUMN IF NOT EXISTS max_transform_creations INTEGER NOT NULL DEFAULT 0;
ALTER TABLE job_capabilities ADD COLUMN IF NOT EXISTS max_transform_runs INTEGER NOT NULL DEFAULT 0;
