...
// any work.
func NewCreateTransformTool(b *base.Context, analyzer transform.Analyzer, engine transform.Engine) (tool.Tool, error) {
	return functiontool.New(functiontool.Config{
	...
	}, func(ctx tool.Context, args CreateTransformArgs) (CreateTransformResult, error) {
		...
		return runCreateTransform(ctx, analyzer, engine, args), nil
	})
}
