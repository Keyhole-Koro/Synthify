...
type TreeRepository interface {
	...
	// to the given documentID via document_tree_links. ErrNotFound if the
	// document was created before the link table existed or before its
	// processing job persisted any items.
